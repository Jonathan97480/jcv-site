    ...
    <>
      ...
      <section>
        <div className=" legal padding max-w">
          ...
          <p>
            JVC Consult ne garantit en aucune façon l’exactitude, la précision
            ou l’exhaustivité des informations mises à disposition sur ce site,
            y compris l’ensemble des hyperliens ou toute autre liaison
            informatique utilisée, directement ou indirectement, à partir de ce
            site. Les photos présentées sur le site JVC Consult sont non
            contractuelles. La société JVC Consult s’efforce d’assurer la
            fiabilité de l’ensemble des informations diffusées sur ce site, dont
            elle se réserve le droit de modifier ou de corriger, à tout moment
          ...
          <div className="legal__block">
            ...
            <p>
              ...
              informations disponibles sur le site. Pour tout dommage
              susceptible de résulter du crédit accordé à ces informations, de
              leur utilisation ou de l’utilisation d’un produit ou service
              auquel elles font référence.
            </p>

            <p>
              Et plus généralement pour tous dommages, directs ou indirects,
              quelles qu’en soient les causes, origines, natures et
              conséquences, provoquées à raison de l’accès de quiconque à ce
              site, de son usage ou de l’usage d’autres sites qui lui sont liés,
              de même que de l’impossibilité d’accéder à ce site. Les documents
              contenus dans ce site et chacun des éléments créés pour ce site
              sont soumis aux dispositions régissant le droit de la propriété
              intellectuelle.
            </p>
            <p>
              Aucune licence, ni aucun autre droit que celui de consulter ce
              site, n’est conféré à quiconque au regard de ces mêmes
              dispositions. La reproduction de tous documents publiés sur ce
              site est uniquement autorisée aux fins exclusives d’information
              pour un usage personnel et privé, toute reproduction et toute
              utilisation de copies réalisées à d’autres fins étant expressément
              interdite.
            </p>
            <p>
              Toute personne citée sur une page de ce site peut exercer ses
              droits d’accès, de modification, de rectification ou de
          ...
          <div className="legal__block">
            ...
            <p>
              Toute tentative de représentation totale ou partielle du site et
              de son contenu sans autorisation préalable de la société JVC
              Consult, est strictement interdite sous peine d’entrer en
              infraction avec le Code de la Propriété intellectuelle qui
              sanctionne les délits de contrefaçon.
            </p>
            <p>
              ...
              dire ne pas reproduire, modifier, altérer ou rediffuser, sans
              notre autorisation, quelque article, titre, applications,
              logiciels, logo, marque, information pour un usage autre que
              strictement privé, ce qui exclut toute reproduction à des fins
            ...
            <p>
              La violation de ces dispositions impératives soumet le
              contrevenant, et toutes personnes responsables, aux peines pénales
          ...
          <div className="legal__block">
            ...
            <p>
              JVC Consult s’engage à assurer la sécurité des informations que
              les utilisateurs lui confient en ligne.
            </p>
            <p>
              {" "}
