      ...
      <div className="aboutPage">
        <div className="aboutPage__content padding max-w">
          ...
          <p>
            ...
            vulputate eu. Ac sed interdum cursus proin. Lorem ipsum dolor sit
            amet consectetur. Faucibus vitae ornare eu mattis pellentesque morbi
            et duis condimentum. Sollicitudin risus enim felis nunc vitae. Hac
