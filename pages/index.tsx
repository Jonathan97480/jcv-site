...
import { selectPartenaires, selectPartenairesLoading } from "../slice/partenairesSlice";
...
export default function Home() {
  ...
  useEffect(() => {
    if (partenairesLoading && categoryLoading)
      set_Loading(false);
          ...
          <div className="partners__content">
            {
              partenairesRedux.map((partenaire: apiPartenaire) => {
                ...
                return (
                  <a href={partenaire.lien ? partenaire.lien : "#"} target="_blank" key={partenaire.id + "-partenaire"}  >
                    <div className="partners__card">
                      <Image src={partenaire.logo} alt={partenaire.nom} width={200} height={200} />
                    </div>
                  </a>
                )
              })}
