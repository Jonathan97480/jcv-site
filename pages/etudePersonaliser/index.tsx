                        ...
                        <div key={index + "-form"}className="form-opacity">
                          ...
                          <div className="etude__btn">
                            <button
                              className="btn"
                              style={
                                formNumber.curentForm ===0?{backgroundColor: 'var(--links-off-color)'}:{backgroundColor: 'var(--links-primary-color)'}
                              }
                              onClick={() => {
                            ...
                            className="btn"
                              style={
                                ...
                                formNumber.numberForm - 1?{backgroundColor: 'var(--links-off-color)'}:{backgroundColor: 'var(--links-primary-color)'}
                              }
                              onClick={() => {
                                if (
                                  formNumber.curentForm <
